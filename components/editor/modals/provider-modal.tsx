...
export const ProviderModal = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-xl p-6 shadow-2xl w-full max-w-md flex flex-col gap-4 animate-scale-in text-slate-800 dark:text-slate-200 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-4 text-xs">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder={isEn ? "Example: huggingface-prod, groq-main, my-seller-proxy" : "Contoh: huggingface-prod, groq-main, my-seller-proxy"}
              ...
              className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-800 dark:text-slate-200 outline-none font-bold bg-slate-50/50 dark:bg-slate-800 disabled:bg-slate-100 dark:disabled:bg-slate-900 disabled:text-slate-400 dark:disabled:text-slate-600"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="text"
              placeholder={isEn ? "Example: Hugging Face Production Hub, Groq LPU Cloud" : "Contoh: Hugging Face Production Hub, Groq LPU Cloud"}
              value={modalProviderState.name}
              onChange={(e) => setModalProviderState((prev: any) => ({ ...prev, name: e.target.value }))}
              className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-800 dark:text-slate-200 font-bold outline-none bg-white dark:bg-slate-900"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-800 dark:text-slate-200 font-semibold outline-none bg-white dark:bg-slate-900"
            >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="text"
              placeholder={isEn ? "Default: https://router.huggingface.co/v1 or https://api.groq.com/openai/v1" : "Default: https://router.huggingface.co/v1 atau https://api.groq.com/openai/v1"}
              value={modalProviderState.base_url || ''}
              onChange={(e) => setModalProviderState((prev: any) => ({ ...prev, base_url: e.target.value }))}
              className="w-full border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2 text-xs text-slate-800 dark:text-slate-200 font-mono outline-none bg-white dark:bg-slate-900"
            />
          </div>
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-100 dark:border-slate-800 pt-4 mt-2">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex items-center justify-center px-5 py-2.5 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-xl transition cursor-pointer shrink-0 whitespace-nowrap"
          >
