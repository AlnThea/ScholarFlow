...
import { SidebarDocumentsView } from './sidebar/sidebar-documents-view';
import { SidebarLibraryView } from './sidebar/sidebar-library-view';
import { SidebarSettingsView } from './sidebar/sidebar-settings-view';
...
export function MinimalSidebar({ 
  ...
  activeDashboardTab?: 'user' | 'admin' | 'billing' | 'admin-pricing' | 'admin-models' | 'admin-gateways' | 'bibliometric' | 'library' | 'explore';
  className?: string;
  isDarkMode?: boolean;
  ...
  return (
    ...
    >
      ...
      {activeView === 'main' && (
        <SidebarMainView
          language={language}
          isEffectiveExpanded={isEffectiveExpanded}
          onToggle={onToggle}
          currentDocumentId={currentDocumentId}
